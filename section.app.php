	...
	<div class="section-container">
		<div class="section-app-content">
			...
			<p class="section-app-text">
				...
				la Dirección General de Servicios Urbanos, puso en marcha el programa Bache 24, con la finalidad de
				atender en un plazo no mayor a 24 horas, los reportes realizados por la ciudadanía en la red vial primaria.
